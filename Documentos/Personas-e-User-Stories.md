...
##  **Personas e User Stories - UniRide**

### **Persona 1 - Gabriel Souza (Preferências do Motorista)**
...
- Tesla e Toyota (tecnologias inovadoras e economia de combustível)  

- Uber e BlaBlaCar (praticidade e compartilhamento de caronas)  

- Spotify e Audible (música e podcasts durante os trajetos)  

### Expectativas não atendidas:

- Falta de personalização na escolha de passageiros 

- Pouca flexibilidade para definir regras e preferências  

- Aplicativos de transporte não consideram o conforto do motorista  

### Medos e receios:

- Passageiros que desrespeitam seu espaço

- Não poder selecionar quem entra no seu carro  

- Falta de suporte caso precise cancelar uma carona  

### Objetivos:

- Ter controle sobre quem compartilha carona com ele  

- Definir preferências de trajeto e comportamento dos passageiros  

- Usar um aplicativo que respeite seu estilo de condução  

### Necessidades:

- Sistema que permita configurar preferências (horários, paradas, regras)  
...
### **Persona 2 - Marina Oliveira (Lucro bem distribuído)**
...
- BlaBlaCar e Buser (economia no transporte)  
- Shopee e AliExpress (custo-benefício)  

### Expectativas não atendidas:
- Taxas altas reduzindo seus ganhos  
- Falta de um sistema que permita visualizar claramente os custos  
- Pouca valorização dos motoristas nos aplicativos tradicionais  

### Medos e receios:
- Não conseguir lucrar o suficiente para cobrir os gastos com o carro  
- Falta de transparência na divisão dos valores  
- Aplicativos que dificultam a retirada dos ganhos  

### Objetivos:
- Encontrar um sistema que distribua melhor os lucros  
- Garantir que seus custos com combustível e manutenção sejam cobertos  
- Usar uma plataforma que facilite o recebimento do dinheiro  

### Necessidades:
- Modelo de precificação justo e transparente  
...
- Uber e 99 (conectividade com motoristas e passageiros)  
- Tesla (inovação em transporte)  

### Expectativas não atendidas:
- Aplicativos de transporte não levam em conta trajetos já planejados  
- Falta de integração com sistemas de navegação eficientes  
- Passageiros escolhendo locais de embarque que desviam muito do caminho  

### Medos e receios:
- Perder tempo indo buscar passageiros muito distantes  
- Gastar mais combustível do que o previsto  
- Não ter controle sobre o percurso  

### Objetivos:
- Garantir que as rotas sejam otimizadas automaticamente  
- Reduzir desvios e tempo perdido na viagem  
- Manter um custo-benefício positivo ao oferecer caronas  

### Necessidades:
- Sistema de roteamento inteligente integrado ao aplicativo  
